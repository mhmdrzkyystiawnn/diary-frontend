...
export default function DetailPage() {
  ...
  if (status === 'loading' || loading) return <div className="text-white text-center mt-20">Membuka Kenangan...</div>;
  if (!file) return <div className="text-white text-center">File tidak ditemukan.</div>;
    ...
    <div className="min-h-screen bg-gray-900 text-white p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {file.type === 'PHOTO' ? (
            ...
            <div className="w-full">
               <div className="text-center mb-6">
                  ...
                  <p className="text-xl font-bold truncate">{file.originalName}</p>
               </div>
        ...
        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-indigo-400">📖 Cerita di balik ini</h2>
