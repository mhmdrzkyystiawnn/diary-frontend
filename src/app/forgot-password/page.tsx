  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-900 text-white p-4">
      <div className="w-full max-w-md p-8 bg-gray-800 rounded-2xl shadow-xl border border-gray-700 text-center">
        <h1 className="text-2xl font-bold mb-2 text-indigo-400">Lupa Password?</h1>
        ...
        <div className="mt-6">
            <Link href="/login" className="text-gray-400 hover:text-white flex items-center justify-center gap-2 text-sm">
